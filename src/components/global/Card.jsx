...
const Card = ({image,projectname,link}) => {
  return (
    ...
    {link ? (
<div className='px-2'>
    <a href={link} target="_blank" rel="noopener noreferrer" className='font-outfit py-2 mt-5 text-lg bg-red-950 flex items-center justify-center hover:scale-105 hover:cursor-pointer border-x-2 rounded-xl'>{projectname}</a>
  </div>
    ):(
  <div className='px-2'>
